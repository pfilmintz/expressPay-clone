...
class MerchantsVC: UIViewController,UISearchBarDelegate,UICollectionViewDelegate,UICollectionViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        var merchant4 = Merchant(title: "Vodafone Prepaid TopUp",section: "AIRTIME-TOPUP", image: #imageLiteral(resourceName: "vod2"))
        
        var merchant5 = Merchant(title: "MTN Fiber",section: "INTERNET", image: #imageLiteral(resourceName: "mtn"))
        var merchant6 = Merchant(title: "MTN 4G Data",section: "INTERNET", image: #imageLiteral(resourceName: "mtn"))
        var merchant7 = Merchant(title: "Glo Data",section: "INTERNET", image: #imageLiteral(resourceName: "glo"))
        var merchant8 = Merchant(title: "Vodafone Broadband",section: "INTERNET", image: #imageLiteral(resourceName: "vod2"))
        
        var merchant9 = Merchant(title: "Blue Data Plan",section: "INTERNET", image: #imageLiteral(resourceName: "blu"))
        var merchant11 = Merchant(title: "Blue Refill",section: "INTERNET", image: #imageLiteral(resourceName: "blu"))
        var merchant12 = Merchant(title: "Busy 4G Data",section: "INTERNET", image: #imageLiteral(resourceName: "busy"))
        var merchant13 = Merchant(title: "Surfline Data Bundles",section: "INTERNET", image: #imageLiteral(resourceName: "surfline"))
